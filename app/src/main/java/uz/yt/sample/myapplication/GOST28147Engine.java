...
public class GOST28147Engine {
    ...
    private static void addSBox(String sBoxName, byte[] sBox) {
        sBoxes.put(sBoxName.toUpperCase(), sBox);
    }
    ...
    /**
     * Инициализирует шифр ГОСТ 28147-89.
     *
     * @param forEncryption если равно true то используется для шифрования, иначе для дешифрования.
     * @param params        параметр шифра.
     * @throws IllegalArgumentException ислючение при несоответствующих аргументах
     */
    ...
    /**
     * Преобразует блок данных
     *
     * @param in     массив данных
     * @param inOff  начальная позиция в массиве данных
     * @param out    ссылка на массив результата преобразований
     * @param outOff начальная позиция на массив результата преобразований
    ...
    /**
     * Возвращает S-Box асоциированный с SBoxName
     *
     * @param sBoxName название S-Box
     * @return массив байтов значений S-Box
     */
    public static byte[] getSBox(
            String sBoxName) {
        byte[] sBox = (byte[]) sBoxes.get(sBoxName.toUpperCase());
